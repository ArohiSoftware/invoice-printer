...
import { FaBars, FaTachometerAlt, FaTruck, FaBox, FaPersonBooth, FaShoppingCart, FaEye, FaUser, FaUsersCog, FaCog } from 'react-icons/fa';
...
return (
    <nav className="bg-blue-600 fixed top-0 z-50 w-full p-3  shadow-lg">
      <div className="flex justify-between items-center">
        ...
        <div className="text-white text-sm hidden md:flex space-x-4">
